...
//    public var imgLogo: UIImage = UIImage(named:"twitterlogo")!
    ...
    public var firstColor: UIColor? = #colorLiteral(red: 0.9803921569, green: 0.5764705882, blue: 0.2156862745, alpha: 1)
   
    // Add second and third colour if you want layer to have multiple colors. It will show animated colors on progressView layer
    public var secondColor: UIColor? = #colorLiteral(red: 1, green: 0.568627451, blue: 0.2666666667, alpha: 1)
    public var thirdColor: UIColor? = #colorLiteral(red: 0.8509803922, green: 0.4117647059, blue: 0.1568627451, alpha: 1)
...
//        imgViewLogo.image = imgLogo
    ...
    public func show() {
        ...
        self.bgColor =  UIColor.black.withAlphaComponent(0.3)
